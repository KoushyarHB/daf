...
const variantClasses = {
  ...
  modal:
    "rounded-md border border-daf-border-input bg-white p-2 px-[0.6rem] font-inherit text-[0.95rem] font-normal min-h-[3.25rem] resize-y focus:border-daf-head/55 focus:shadow-daf-focus focus:outline-none",
  mono:
